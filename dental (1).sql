...
(3, 'Tan Yang Linn', '2017-12-22', '14:00:00', 1),
(4, 'Tan Yang Linn', '2018-01-08', '20:00:00', 1);
...
(1, 'Tan Yang Linn', 'B031510193', 'FTMK', '960525045291', 'Student', 'Male', 'Malaysian', '0102717040', '765, JALAN KOTA KENARI 4/5,\r\nKOTA KENARI, 09000\r\nKULIM, KEDAH\r\nMALAYSIA', 'approve', 0),
...
(23, 'sdasda', 'sdjkshakd', 'asdsa', '95654', 'Student', 'Male', 'Mlaysads', '021231516', 'bdsahdbsajh', 'approve', 0),
(24, 'aas', 'b123', 'ftmk', '123', 'Staff', 'Male', 'malay', '123', 'melaka', 'approve', 0),
(25, 'aas', 'b123', 'ftmk', '123', 'Staff', 'Male', 'malay', '123', 'melaka', 'approve', 0),
(26, 'test', '123', 'ftk', '123', 'Student', 'Male', 'malay', '1223', 'mlk', 'approve', 0),
(27, 'test', '123', 'ftk', '123', 'Staff', 'Male', 'mly`', '123343', 'mlk', 'approve', 0),
(28, 'test', '123', 'ftk', '132', 'Staff', 'Male', 'mly', '`123', 'mlk', 'approve', 0),
(29, 'test', '123', 'ftk', '132', 'Staff', 'Male', 'mly', '`123', 'mlk', 'approve', 0),
(30, 'yhbgty', 'dfdgfr', 'fd', '3457', 'Student', 'Female', 'fdgfg', '3446', 'mmlk', 'approve', 0),
(31, 'yhbgty', 'dfdgfr', 'fd', '3457', 'Student', 'Female', 'fdgfg', '3446', 'mmlk', 'approve', 0),
(32, 'nhgnj', 'ghtyj', 'htgyhgt', '76996', 'Staff', 'Male', 'hghty', '443546', 'jhh', 'approve', 0),
(33, 'nhgnj', 'ghtyj', 'htgyhgt', '76996', 'Staff', 'Male', 'hghty', '443546', 'jhh', 'approve', 0),
(34, 'ghghbgf', '4566', 'dfvgdgr', '24334', 'Staff', 'Male', 'frgrg', 'ghgf', 'mj', 'approve', 0),
(35, 'hi', '123', 'ftk', '1234', 'Staff', 'Female', 'mly', '123456', 'mlk', 'approve', 0),
(36, 'hio', '132435', 'sdfg', 'sdf', 'Staff', 'Male', 'sdsfg', '1324', 'sdfg', 'approve', 0),
(37, 'gg', 'frgr', 'tgt', '3456', 'Student', 'Female', 'vrf', '354656', 'hgbhty', 'approve', 0),
(38, 'test', '123', 'ftk', '123', 'Staff', 'Female', 'malay', '123', 'mlk', 'approve', 0);
...
CREATE TABLE `profile` (
  ...
  `new_ic` varchar(15) NOT NULL,
  `old_ic` varchar(15) NOT NULL,
  `status` varchar(12) NOT NULL,
  `tempatbertugas` varchar(32) NOT NULL,
  `gelaran` varchar(15) NOT NULL,
  `jantina` varchar(16) NOT NULL,
  `agama` varchar(16) NOT NULL,
  `keturunan` varchar(16) NOT NULL,
  `umur` int(10) NOT NULL,
  `dob` date NOT NULL,
  `pob` varchar(20) NOT NULL,
  `nationality` varchar(20) NOT NULL,
  `marrital` varchar(12) NOT NULL,
  `alamat_kediaman` varchar(50) NOT NULL,
  `poskod` int(5) NOT NULL,
  `bandar` varchar(15) NOT NULL,
  `negeri` varchar(18) NOT NULL,
  `negara` varchar(16) NOT NULL,
  `tel_rumah` int(15) NOT NULL,
  `tel_bimbit` int(15) NOT NULL,
  `tel_pejabat` int(15) NOT NULL,
...
(4, '2017-12-22', '14:00:00', 1, 1),
(5, '2017-12-22', '14:00:00', 4, 2),
(6, '2018-01-05', '11:30:00', 1, 1),
(7, '2018-03-01', '14:00:00', 1, 1);
...
(5, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'registrar');
...
--
ALTER TABLE `patient_info`
  MODIFY `patient_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
